    ...
    <div class="add-form">
        ...
        if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
            ...
            <form name="insertNewPlayer" method="POST" action="player.php">
                <p><label>Имя игрока<input type="text" name="name" maxlength="50" pattern="[A-ZА-Я^ЪЬ]{1}[A-ZА-ЯЁa-zа-яё -]{1,49}" placeholder="Adam" required /></label></p>
                <p><label>Фамилия игрока<input type="text" name="surname" maxlength="100" pattern="[A-ZА-Я^ЪЬ]{1}[A-ZА-ЯЁa-zа-яё -]{1,99}" placeholder="Smith" required /></label></p>
                <p><label>Телефон<input type="text" name="phone" maxlength="11" pattern="[0-9]{11}" placeholder="12345678901" required /></label></p>
