            ...
            if ($stmt->prepare($query) && $stmt->execute()) {
                ...
                if ($stmt->num_rows == 0 && !isset($_POST['edit'])) {
                    ...
                    <div style="color: indianred;">
                        ...
                        <p>
                            <output>Для добавления игры, пожалуйста, добавьте новую команду</output>
                        </p>
                        <p>
                            <output>Напомним, что у команды всегда должен быть капитан, то есть если Вы хотите добавить
                    ...
                    if ($stmt->prepare($query) && $stmt->execute()) {
                        ...
                        if ($stmt->num_rows == 0) {
                            ...
                            <div style="color: indianred;">
                                <p>
                                    <output>В базе данных отсутствуют площадки</output>
                                </p>
                                <p>
                                    <output>Для добавления игры, пожалуйста, добавьте новую площадку</output>
                                </p>
                            </div>
                            <?php
                        } else {
