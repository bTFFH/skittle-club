                ...
                if ($stmt->num_rows == 0) {
                    ...
                    if ($stmt->execute()) {
                        ...
                        if ($stmt->num_rows == 0) {
                            ...
                            <div style="color: indianred;">
                                <p>
                                    <output>В базе данных отсутствуют игры</output>
                                </p>
                                <p>
                                    <output>Для добавления статистики игры, пожалуйста, добавьте новую игру</output>
                                </p>
                            </div>
                            <?php
                        } else {
                            ...
                            <form name="insertNewGame" method="POST" action="competition.php">
                                ...
                                <p><select name="competition" style="width: 400px"><?php echo $competitions; ?></select>
                                </p>
